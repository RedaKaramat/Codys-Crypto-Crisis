...
const Difficulty = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black text-white px-4 py-10">
      <div className="bg-zinc-900 border border-purple-500 rounded-lg p-6 sm:p-10 w-full max-w-2xl shadow-lg text-center">
        <h1 className="text-3xl sm:text-4xl font-bold text-white mb-8">Select Your Difficulty</h1>

        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-6">
          <button
            onClick={() => handleSelect('Beginner')}
            className="bg-green-600 hover:bg-green-700 text-white font-semibold px-6 py-3 text-base sm:text-lg rounded transition"
          >
            Beginner
          </button>
          <button
            onClick={() => handleSelect('Intermediate')}
            className="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold px-6 py-3 text-base sm:text-lg rounded transition"
          >
            Intermediate
          </button>
          <button
            onClick={() => handleSelect('Expert')}
            className="bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-3 text-base sm:text-lg rounded transition"
          >
            Expert
          </button>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-6">
          <button
            ...
            className="bg-blue-500 hover:bg-blue-600 text-white font-semibold px-5 py-2 sm:py-3 text-base sm:text-lg rounded shadow"
          >
            📘 How to Play
          </button>
          <button
            onClick={() => setShowGlossary((prev) => !prev)}
            className="bg-green-700 hover:bg-green-800 text-white font-semibold px-5 py-2 sm:py-3 text-base sm:text-lg rounded shadow"
          >
            📚 Pattern Glossary
          </button>
        </div>
        ...
        {showHowToPlay && (
          <div className="mt-4 text-base sm:text-lg text-gray-300 leading-relaxed px-4 animate-fadeSlide">
            <p>
        ...
        {showGlossary && (
          <div className="mt-6 text-base sm:text-lg text-gray-300 leading-relaxed text-center px-6 animate-fadeSlide">
